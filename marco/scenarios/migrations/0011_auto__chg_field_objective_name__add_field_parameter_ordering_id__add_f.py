...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Objective.name'
        db.alter_column('scenarios_objective', 'name', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Adding field 'Parameter.ordering_id'
        db.add_column('scenarios_parameter', 'ordering_id', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Parameter.shortname'
        db.add_column('scenarios_parameter', 'shortname', self.gf('django.db.models.fields.CharField')(default='', max_length=35), keep_default=False)

        # Changing field 'Parameter.name'
        db.alter_column('scenarios_parameter', 'name', self.gf('django.db.models.fields.CharField')(max_length=35))


    def backwards(self, orm):
        
        # Changing field 'Objective.name'
        db.alter_column('scenarios_objective', 'name', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Deleting field 'Parameter.ordering_id'
        db.delete_column('scenarios_parameter', 'ordering_id')

        # Deleting field 'Parameter.shortname'
        db.delete_column('scenarios_parameter', 'shortname')

        # Changing field 'Parameter.name'
        db.alter_column('scenarios_parameter', 'name', self.gf('django.db.models.fields.CharField')(max_length=70))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 17, 4, 53, 806000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 17, 4, 53, 806000)'}),
        ...
        'scenarios.parameter': {
            ...
            'ordering_id': ('django.db.models.fields.IntegerField', [], {}),
            'shortname': ('django.db.models.fields.CharField', [], {'max_length': '35'})
        },
        'scenarios.scenario': {
