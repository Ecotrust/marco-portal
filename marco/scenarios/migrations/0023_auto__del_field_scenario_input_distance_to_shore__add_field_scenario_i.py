...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Scenario.input_distance_to_shore'
        db.delete_column('scenarios_scenario', 'input_distance_to_shore')

        # Adding field 'Scenario.input_min_distance_to_shore'
        db.add_column('scenarios_scenario', 'input_min_distance_to_shore', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.input_max_distance_to_shore'
        db.add_column('scenarios_scenario', 'input_max_distance_to_shore', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Scenario.input_distance_to_shore'
        db.add_column('scenarios_scenario', 'input_distance_to_shore', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 17, 26, 33, 10000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 17, 26, 33, 10000)'}),
