...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeaseBlock.wpa_name'
        db.add_column('scenarios_leaseblock', 'wpa_name',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.shipwreck_density'
        db.add_column('scenarios_leaseblock', 'shipwreck_density',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.uxo'
        db.add_column('scenarios_leaseblock', 'uxo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.substation_min_distance'
        db.add_column('scenarios_leaseblock', 'substation_min_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.substation_max_distance'
        db.add_column('scenarios_leaseblock', 'substation_max_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.substation_mean_distance'
        db.add_column('scenarios_leaseblock', 'substation_mean_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.marco_region'
        db.add_column('scenarios_leaseblock', 'marco_region',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeaseBlock.wpa_name'
        db.delete_column('scenarios_leaseblock', 'wpa_name')

        # Deleting field 'LeaseBlock.shipwreck_density'
        db.delete_column('scenarios_leaseblock', 'shipwreck_density')

        # Deleting field 'LeaseBlock.uxo'
        db.delete_column('scenarios_leaseblock', 'uxo')

        # Deleting field 'LeaseBlock.substation_min_distance'
        db.delete_column('scenarios_leaseblock', 'substation_min_distance')

        # Deleting field 'LeaseBlock.substation_max_distance'
        db.delete_column('scenarios_leaseblock', 'substation_max_distance')

        # Deleting field 'LeaseBlock.substation_mean_distance'
        db.delete_column('scenarios_leaseblock', 'substation_mean_distance')

        # Deleting field 'LeaseBlock.marco_region'
        db.delete_column('scenarios_leaseblock', 'marco_region')
