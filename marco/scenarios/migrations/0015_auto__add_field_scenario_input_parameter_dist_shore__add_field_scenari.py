...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scenarios_scenario', 'input_parameter_depth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Scenario.input_parameter_wind_speed'
        db.add_column('scenarios_scenario', 'input_parameter_wind_speed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Scenario.input_parameter_substrate'
        db.add_column('scenarios_scenario', 'input_parameter_substrate', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Scenario.input_parameter_substrate'
        db.delete_column('scenarios_scenario', 'input_parameter_substrate')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 16, 15, 37, 30, 695000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 16, 15, 37, 30, 695000)'}),
        ...
        'scenarios.scenario': {
            ...
            'input_parameter_dist_shore': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
