...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scenarios_scenario', 'input_avg_wind_speed', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding M2M table for field input_substrate on 'Scenario'
        db.create_table('scenarios_scenario_input_substrate', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenarios.scenario'], null=False)),
            ('substrate', models.ForeignKey(orm['scenarios.substrate'], null=False))
        ))
        db.create_unique('scenarios_scenario_input_substrate', ['scenario_id', 'substrate_id'])

        # Changing field 'Scenario.input_max_dist_shore'
        db.alter_column('scenarios_scenario', 'input_max_dist_shore', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_max_depth'
        db.alter_column('scenarios_scenario', 'input_max_depth', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_min_depth'
        db.alter_column('scenarios_scenario', 'input_min_depth', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_min_dist_shore'
        db.alter_column('scenarios_scenario', 'input_min_dist_shore', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('scenarios_scenario_input_substrate')

        # Changing field 'Scenario.input_max_dist_shore'
        db.alter_column('scenarios_scenario', 'input_max_dist_shore', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Scenario.input_max_depth'
        db.alter_column('scenarios_scenario', 'input_max_depth', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Scenario.input_min_depth'
        db.alter_column('scenarios_scenario', 'input_min_depth', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Scenario.input_min_dist_shore'
        db.alter_column('scenarios_scenario', 'input_min_dist_shore', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 16, 10, 55, 103000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 16, 10, 55, 103000)'}),
        ...
        'scenarios.scenario': {
            ...
            'input_max_dist_shore': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'input_min_depth': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'input_min_dist_shore': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
