...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.input_parameter_distance_to_shipping'
        db.add_column('scenarios_scenario', 'input_parameter_distance_to_shipping', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Scenario.input_distance_to_shipping'
        db.add_column('scenarios_scenario', 'input_distance_to_shipping', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.input_parameter_distance_to_shipping'
        db.delete_column('scenarios_scenario', 'input_parameter_distance_to_shipping')

        # Deleting field 'Scenario.input_distance_to_shipping'
        db.delete_column('scenarios_scenario', 'input_distance_to_shipping')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 13, 0, 47, 554000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 13, 0, 47, 554000)'}),
        ...
        'scenarios.scenario': {
            ...
            'input_parameter_distance_to_shipping': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
