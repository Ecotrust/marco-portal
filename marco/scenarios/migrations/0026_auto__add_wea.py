...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WEA'
        db.create_table('scenarios_wea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wea_id', self.gf('django.db.models.fields.IntegerField')()),
            ('wea_name', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('wea_shortname', self.gf('django.db.models.fields.CharField')(max_length=35)),
        ))
        db.send_create_signal('scenarios', ['WEA'])


    def backwards(self, orm):
        
        # Deleting model 'WEA'
        db.delete_table('scenarios_wea')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 14, 13, 52, 33, 614000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 14, 13, 52, 33, 614000)'}),
