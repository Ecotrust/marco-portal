...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.geometry_dissolved'
        db.add_column('scenarios_scenario', 'geometry_dissolved',
    ...
    def backwards(self, orm):
        ...
        db.add_column('scenarios_scenario', 'geometry_final',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Scenario.geometry_dissolved'
        db.delete_column('scenarios_scenario', 'geometry_dissolved')
    ...
    models = {
        ...
        'scenarios.scenario': {
            ...
            'geometry_dissolved': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
