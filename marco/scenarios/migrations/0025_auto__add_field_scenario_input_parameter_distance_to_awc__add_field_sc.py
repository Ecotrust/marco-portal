...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.input_parameter_distance_to_awc'
        db.add_column('scenarios_scenario', 'input_parameter_distance_to_awc', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Scenario.input_distance_to_awc'
        db.add_column('scenarios_scenario', 'input_distance_to_awc', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.input_parameter_distance_to_awc'
        db.delete_column('scenarios_scenario', 'input_parameter_distance_to_awc')

        # Deleting field 'Scenario.input_distance_to_awc'
        db.delete_column('scenarios_scenario', 'input_distance_to_awc')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 14, 12, 15, 54, 769000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 14, 12, 15, 54, 769000)'}),
