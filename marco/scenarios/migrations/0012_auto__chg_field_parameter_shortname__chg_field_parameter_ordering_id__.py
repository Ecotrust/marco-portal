...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Parameter.shortname'
        db.alter_column('scenarios_parameter', 'shortname', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

        # Changing field 'Parameter.ordering_id'
        db.alter_column('scenarios_parameter', 'ordering_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Parameter.name'
        db.alter_column('scenarios_parameter', 'name', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))


    def backwards(self, orm):
        
        # Changing field 'Parameter.shortname'
        db.alter_column('scenarios_parameter', 'shortname', self.gf('django.db.models.fields.CharField')(max_length=35))

        # Changing field 'Parameter.ordering_id'
        db.alter_column('scenarios_parameter', 'ordering_id', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 17, 5, 59, 887000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 10, 17, 5, 59, 887000)'}),
