...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Scenario.input_parameter_distance_to_substation'
        db.add_column('scenarios_scenario', 'input_parameter_distance_to_substation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Scenario.input_distance_to_substation'
        db.add_column('scenarios_scenario', 'input_distance_to_substation',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Scenario.input_parameter_distance_to_substation'
        db.delete_column('scenarios_scenario', 'input_parameter_distance_to_substation')

        # Deleting field 'Scenario.input_distance_to_substation'
        db.delete_column('scenarios_scenario', 'input_distance_to_substation')
