...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Sediment'
        db.create_table('scenarios_sediment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sediment_id', self.gf('django.db.models.fields.IntegerField')()),
            ('sediment_name', self.gf('django.db.models.fields.CharField')(max_length=35)),
            ('sediment_output', self.gf('django.db.models.fields.CharField')(max_length=55)),
            ('sediment_shortname', self.gf('django.db.models.fields.CharField')(max_length=35)),
        ))
        db.send_create_signal('scenarios', ['Sediment'])

        # Adding field 'Scenario.input_parameter_sediment'
        db.add_column('scenarios_scenario', 'input_parameter_sediment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding M2M table for field input_sediment on 'Scenario'
        db.create_table('scenarios_scenario_input_sediment', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenarios.scenario'], null=False)),
            ('sediment', models.ForeignKey(orm['scenarios.sediment'], null=False))
        ))
        db.create_unique('scenarios_scenario_input_sediment', ['scenario_id', 'sediment_id'])


    def backwards(self, orm):
        
        # Deleting model 'Sediment'
        db.delete_table('scenarios_sediment')

        # Deleting field 'Scenario.input_parameter_sediment'
        db.delete_column('scenarios_scenario', 'input_parameter_sediment')

        # Removing M2M table for field input_sediment on 'Scenario'
        db.delete_table('scenarios_scenario_input_sediment')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 16, 36, 20, 698000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 16, 36, 20, 698000)'}),
