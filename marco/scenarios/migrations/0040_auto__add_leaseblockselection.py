...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LeaseBlockSelection'
        db.create_table('scenarios_leaseblockselection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scenarios_leaseblockselection_related', to=orm['auth.User'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='scenarios_leaseblockselection_related', null=True, to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('geometry_actual', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=99996, null=True, blank=True)),
        ))
        db.send_create_signal('scenarios', ['LeaseBlockSelection'])

        # Adding M2M table for field sharing_groups on 'LeaseBlockSelection'
        db.create_table('scenarios_leaseblockselection_sharing_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('leaseblockselection', models.ForeignKey(orm['scenarios.leaseblockselection'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('scenarios_leaseblockselection_sharing_groups', ['leaseblockselection_id', 'group_id'])

        # Adding M2M table for field leaseblocks on 'LeaseBlockSelection'
        db.create_table('scenarios_leaseblockselection_leaseblocks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('leaseblockselection', models.ForeignKey(orm['scenarios.leaseblockselection'], null=False)),
            ('leaseblock', models.ForeignKey(orm['scenarios.leaseblock'], null=False))
        ))
        db.create_unique('scenarios_leaseblockselection_leaseblocks', ['leaseblockselection_id', 'leaseblock_id'])


    def backwards(self, orm):
        # Deleting model 'LeaseBlockSelection'
        db.delete_table('scenarios_leaseblockselection')

        # Removing M2M table for field sharing_groups on 'LeaseBlockSelection'
        db.delete_table('scenarios_leaseblockselection_sharing_groups')

        # Removing M2M table for field leaseblocks on 'LeaseBlockSelection'
        db.delete_table('scenarios_leaseblockselection_leaseblocks')
    ...
    models = {
        ...
        'scenarios.leaseblockselection': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leaseblocks': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scenarios.LeaseBlock']", 'symmetrical': 'False'}),
