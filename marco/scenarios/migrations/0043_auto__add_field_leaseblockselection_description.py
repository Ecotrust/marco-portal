...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeaseBlockSelection.description'
        db.add_column('scenarios_leaseblockselection', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeaseBlockSelection.description'
        db.delete_column('scenarios_leaseblockselection', 'description')
