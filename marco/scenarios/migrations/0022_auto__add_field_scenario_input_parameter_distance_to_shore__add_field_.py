...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scenarios_scenario', 'input_parameter_distance_to_shore', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 16, 36, 4, 471000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 16, 36, 4, 471000)'}),
        ...
        'scenarios.scenario': {
            ...
            'input_distance_to_shore': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
