...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scenarios_leaseblock', 'ais_min_density', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.ais_max_density'
        db.add_column('scenarios_leaseblock', 'ais_max_density', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.ais_mean_density'
        db.add_column('scenarios_leaseblock', 'ais_mean_density', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 11, 16, 0, 513000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 11, 16, 0, 513000)'}),
