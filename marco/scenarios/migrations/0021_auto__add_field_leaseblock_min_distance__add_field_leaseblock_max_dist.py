...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LeaseBlock.min_distance'
        db.add_column('scenarios_leaseblock', 'min_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.max_distance'
        db.add_column('scenarios_leaseblock', 'max_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.avg_distance'
        db.add_column('scenarios_leaseblock', 'avg_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LeaseBlock.min_distance'
        db.delete_column('scenarios_leaseblock', 'min_distance')

        # Deleting field 'LeaseBlock.max_distance'
        db.delete_column('scenarios_leaseblock', 'max_distance')

        # Deleting field 'LeaseBlock.avg_distance'
        db.delete_column('scenarios_leaseblock', 'avg_distance')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 15, 58, 47, 409000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 30, 15, 58, 47, 409000)'}),
