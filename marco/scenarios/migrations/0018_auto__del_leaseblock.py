...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('scenarios_leaseblock', (
            ('block_number', self.gf('django.db.models.fields.CharField')(max_length=6)),
            ...
            ('minority', self.gf('django.db.models.fields.IntegerField')()),
            ('majority_substrate', self.gf('django.db.models.fields.IntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('min_depth', self.gf('django.db.models.fields.FloatField')()),
            ('prot_aprv', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ('prot_number', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('mybc', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry_client', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True)),
            ('avg_wind_speed', self.gf('django.db.models.fields.FloatField')()),
        ))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 16, 33, 16, 349000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 16, 33, 16, 349000)'}),
