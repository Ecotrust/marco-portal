...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LeaseBlock.ais_min_distance'
        db.add_column('scenarios_leaseblock', 'ais_min_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.ais_max_distance'
        db.add_column('scenarios_leaseblock', 'ais_max_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.ais_mean_distance'
        db.add_column('scenarios_leaseblock', 'ais_mean_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.min_wind_speed_rev'
        db.add_column('scenarios_leaseblock', 'min_wind_speed_rev', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.max_wind_speed_rev'
        db.add_column('scenarios_leaseblock', 'max_wind_speed_rev', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.tsz_min_distance'
        db.add_column('scenarios_leaseblock', 'tsz_min_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.tsz_max_distance'
        db.add_column('scenarios_leaseblock', 'tsz_max_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'LeaseBlock.tsz_mean_distance'
        db.add_column('scenarios_leaseblock', 'tsz_mean_distance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LeaseBlock.ais_min_distance'
        db.delete_column('scenarios_leaseblock', 'ais_min_distance')

        # Deleting field 'LeaseBlock.ais_max_distance'
        db.delete_column('scenarios_leaseblock', 'ais_max_distance')

        # Deleting field 'LeaseBlock.ais_mean_distance'
        db.delete_column('scenarios_leaseblock', 'ais_mean_distance')

        # Deleting field 'LeaseBlock.min_wind_speed_rev'
        db.delete_column('scenarios_leaseblock', 'min_wind_speed_rev')

        # Deleting field 'LeaseBlock.max_wind_speed_rev'
        db.delete_column('scenarios_leaseblock', 'max_wind_speed_rev')

        # Deleting field 'LeaseBlock.tsz_min_distance'
        db.delete_column('scenarios_leaseblock', 'tsz_min_distance')

        # Deleting field 'LeaseBlock.tsz_max_distance'
        db.delete_column('scenarios_leaseblock', 'tsz_max_distance')

        # Deleting field 'LeaseBlock.tsz_mean_distance'
        db.delete_column('scenarios_leaseblock', 'tsz_mean_distance')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 11, 3, 10, 657000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 11, 3, 10, 657000)'}),
        ...
        'scenarios.leaseblock': {
            ...
            'ais_max_distance': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_mean_distance': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_min_distance': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
