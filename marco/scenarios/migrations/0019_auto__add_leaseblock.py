...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('scenarios_leaseblock', (
            ...
            ('prot_number', self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True)),
            ('prot_aprv', self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True)),
            ('block_number', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True)),
            ('prot_numb', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('min_depth', self.gf('django.db.models.fields.FloatField')()),
            ('max_depth', self.gf('django.db.models.fields.FloatField')()),
            ('avg_depth', self.gf('django.db.models.fields.FloatField')()),
            ('min_wind_speed', self.gf('django.db.models.fields.FloatField')()),
            ('max_wind_speed', self.gf('django.db.models.fields.FloatField')()),
            ('majority_sediment', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('variety_sediment', self.gf('django.db.models.fields.IntegerField')()),
            ('majority_substrate', self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True)),
            ('variety_substrate', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=99996, null=True, blank=True)),
            ('geometry_client', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 16, 34, 38, 616000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 26, 16, 34, 38, 616000)'}),
