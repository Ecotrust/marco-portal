...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.input_parameter_wea'
        db.add_column('scenarios_scenario', 'input_parameter_wea', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding M2M table for field input_wea on 'Scenario'
        db.create_table('scenarios_scenario_input_wea', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('scenario', models.ForeignKey(orm['scenarios.scenario'], null=False)),
            ('wea', models.ForeignKey(orm['scenarios.wea'], null=False))
        ))
        db.create_unique('scenarios_scenario_input_wea', ['scenario_id', 'wea_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 14, 15, 10, 42, 700000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 14, 15, 10, 42, 700000)'}),
