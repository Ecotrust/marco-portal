...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.input_filter_distance_to_shipping'
        db.add_column('scenarios_scenario', 'input_filter_distance_to_shipping', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Scenario.input_filter_distance_to_shipping'
        db.delete_column('scenarios_scenario', 'input_filter_distance_to_shipping')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 13, 9, 33, 236000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 13, 9, 33, 236000)'}),
