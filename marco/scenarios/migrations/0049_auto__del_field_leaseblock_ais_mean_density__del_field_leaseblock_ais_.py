...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LeaseBlock.ais_mean_density'
        db.delete_column('scenarios_leaseblock', 'ais_mean_density')

        # Deleting field 'LeaseBlock.ais_min_density'
        db.delete_column('scenarios_leaseblock', 'ais_min_density')

        # Deleting field 'LeaseBlock.ais_max_density'
        db.delete_column('scenarios_leaseblock', 'ais_max_density')

        # Adding field 'LeaseBlock.ais_all_vessels_low'
        db.add_column('scenarios_leaseblock', 'ais_all_vessels_low',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_all_vessels_medium'
        db.add_column('scenarios_leaseblock', 'ais_all_vessels_medium',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_all_vessels_high'
        db.add_column('scenarios_leaseblock', 'ais_all_vessels_high',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_cargo_vessels_low'
        db.add_column('scenarios_leaseblock', 'ais_cargo_vessels_low',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_cargo_vessels_medium'
        db.add_column('scenarios_leaseblock', 'ais_cargo_vessels_medium',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_cargo_vessels_high'
        db.add_column('scenarios_leaseblock', 'ais_cargo_vessels_high',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_passenger_vessels_low'
        db.add_column('scenarios_leaseblock', 'ais_passenger_vessels_low',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_passenger_vessels_medium'
        db.add_column('scenarios_leaseblock', 'ais_passenger_vessels_medium',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_passenger_vessels_high'
        db.add_column('scenarios_leaseblock', 'ais_passenger_vessels_high',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_tanker_vessels_low'
        db.add_column('scenarios_leaseblock', 'ais_tanker_vessels_low',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_tanker_vessels_medium'
        db.add_column('scenarios_leaseblock', 'ais_tanker_vessels_medium',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_tanker_vessels_high'
        db.add_column('scenarios_leaseblock', 'ais_tanker_vessels_high',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_tugtow_vessels_low'
        db.add_column('scenarios_leaseblock', 'ais_tugtow_vessels_low',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_tugtow_vessels_medium'
        db.add_column('scenarios_leaseblock', 'ais_tugtow_vessels_medium',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_tugtow_vessels_high'
        db.add_column('scenarios_leaseblock', 'ais_tugtow_vessels_high',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LeaseBlock.ais_mean_density'
        db.add_column('scenarios_leaseblock', 'ais_mean_density',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_min_density'
        db.add_column('scenarios_leaseblock', 'ais_min_density',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.ais_max_density'
        db.add_column('scenarios_leaseblock', 'ais_max_density',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LeaseBlock.ais_all_vessels_low'
        db.delete_column('scenarios_leaseblock', 'ais_all_vessels_low')

        # Deleting field 'LeaseBlock.ais_all_vessels_medium'
        db.delete_column('scenarios_leaseblock', 'ais_all_vessels_medium')

        # Deleting field 'LeaseBlock.ais_all_vessels_high'
        db.delete_column('scenarios_leaseblock', 'ais_all_vessels_high')

        # Deleting field 'LeaseBlock.ais_cargo_vessels_low'
        db.delete_column('scenarios_leaseblock', 'ais_cargo_vessels_low')

        # Deleting field 'LeaseBlock.ais_cargo_vessels_medium'
        db.delete_column('scenarios_leaseblock', 'ais_cargo_vessels_medium')

        # Deleting field 'LeaseBlock.ais_cargo_vessels_high'
        db.delete_column('scenarios_leaseblock', 'ais_cargo_vessels_high')

        # Deleting field 'LeaseBlock.ais_passenger_vessels_low'
        db.delete_column('scenarios_leaseblock', 'ais_passenger_vessels_low')

        # Deleting field 'LeaseBlock.ais_passenger_vessels_medium'
        db.delete_column('scenarios_leaseblock', 'ais_passenger_vessels_medium')

        # Deleting field 'LeaseBlock.ais_passenger_vessels_high'
        db.delete_column('scenarios_leaseblock', 'ais_passenger_vessels_high')

        # Deleting field 'LeaseBlock.ais_tanker_vessels_low'
        db.delete_column('scenarios_leaseblock', 'ais_tanker_vessels_low')

        # Deleting field 'LeaseBlock.ais_tanker_vessels_medium'
        db.delete_column('scenarios_leaseblock', 'ais_tanker_vessels_medium')

        # Deleting field 'LeaseBlock.ais_tanker_vessels_high'
        db.delete_column('scenarios_leaseblock', 'ais_tanker_vessels_high')

        # Deleting field 'LeaseBlock.ais_tugtow_vessels_low'
        db.delete_column('scenarios_leaseblock', 'ais_tugtow_vessels_low')

        # Deleting field 'LeaseBlock.ais_tugtow_vessels_medium'
        db.delete_column('scenarios_leaseblock', 'ais_tugtow_vessels_medium')

        # Deleting field 'LeaseBlock.ais_tugtow_vessels_high'
        db.delete_column('scenarios_leaseblock', 'ais_tugtow_vessels_high')
    ...
    models = {
        ...
        'scenarios.leaseblock': {
            ...
            'ais_all_vessels_high': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_all_vessels_low': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_all_vessels_maj': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ais_all_vessels_medium': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_cargo_vessels_high': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_cargo_vessels_low': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_cargo_vessels_maj': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ais_cargo_vessels_medium': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_passenger_vessels_high': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_passenger_vessels_low': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_passenger_vessels_maj': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ais_passenger_vessels_medium': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tanker_vessels_high': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tanker_vessels_low': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tanker_vessels_maj': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tanker_vessels_medium': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tugtow_vessels_high': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tugtow_vessels_low': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tugtow_vessels_maj': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'ais_tugtow_vessels_medium': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
