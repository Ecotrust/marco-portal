...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LeaseBlockSelection.leaseblock_ids'
        db.add_column('scenarios_leaseblockselection', 'leaseblock_ids', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LeaseBlockSelection.leaseblock_ids'
        db.delete_column('scenarios_leaseblockselection', 'leaseblock_ids')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 9, 15, 25, 31, 344000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 9, 15, 25, 31, 344000)'}),
        ...
        'scenarios.leaseblockselection': {
            ...
            'leaseblocks': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenarios.LeaseBlock']", 'null': 'True', 'blank': 'True'}),
