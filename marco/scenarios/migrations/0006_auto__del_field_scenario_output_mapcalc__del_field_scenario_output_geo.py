...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('scenarios_scenario', 'output_mapcalc')

        # Deleting field 'Scenario.output_geom'
        db.delete_column('scenarios_scenario', 'output_geom')

        # Deleting field 'Scenario.output_area'
        db.delete_column('scenarios_scenario', 'output_area')

        # Deleting field 'Scenario.geometry_final'
        db.delete_column('scenarios_scenario', 'geometry_final')

        # Adding M2M table for field lease_blocks on 'Scenario'
        db.create_table('scenarios_scenario_lease_blocks', (
        ...
        db.create_unique('scenarios_scenario_lease_blocks', ['scenario_id', 'leaseblock_id'])


    def backwards(self, orm):
        
        # Adding field 'Scenario.output_mapcalc'
        db.add_column('scenarios_scenario', 'output_mapcalc', self.gf('django.db.models.fields.CharField')(max_length=360, null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.output_geom'
        db.add_column('scenarios_scenario', 'output_geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=99996, null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.output_area'
        db.add_column('scenarios_scenario', 'output_area', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Scenario.geometry_final'
        db.add_column('scenarios_scenario', 'geometry_final', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=99996, null=True, blank=True), keep_default=False)

        # Removing M2M table for field lease_blocks on 'Scenario'
        db.delete_table('scenarios_scenario_lease_blocks')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 12, 15, 20, 318000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 12, 15, 20, 318000)'}),
        ...
        'scenarios.scenario': {
            ...
            'lease_blocks': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['scenarios.LeaseBlock']", 'null': 'True', 'blank': 'True'}),
