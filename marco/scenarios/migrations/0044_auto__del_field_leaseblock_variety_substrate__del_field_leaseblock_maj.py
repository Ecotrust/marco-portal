...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LeaseBlock.variety_substrate'
        db.delete_column('scenarios_leaseblock', 'variety_substrate')

        # Deleting field 'LeaseBlock.majority_substrate'
        db.delete_column('scenarios_leaseblock', 'majority_substrate')

        # Deleting field 'LeaseBlock.geometry_client'
        db.delete_column('scenarios_leaseblock', 'geometry_client')

        # Adding field 'LeaseBlock.majority_seabed'
        db.add_column('scenarios_leaseblock', 'majority_seabed',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.variety_seabed'
        db.add_column('scenarios_leaseblock', 'variety_seabed',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.lace_coral_count'
        db.add_column('scenarios_leaseblock', 'lace_coral_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.lace_coral_name'
        db.add_column('scenarios_leaseblock', 'lace_coral_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.black_coral_count'
        db.add_column('scenarios_leaseblock', 'black_coral_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.black_coral_name'
        db.add_column('scenarios_leaseblock', 'black_coral_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.soft_coral_count'
        db.add_column('scenarios_leaseblock', 'soft_coral_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.soft_coral_name'
        db.add_column('scenarios_leaseblock', 'soft_coral_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.gorgo_coral_count'
        db.add_column('scenarios_leaseblock', 'gorgo_coral_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.gorgo_coral_name'
        db.add_column('scenarios_leaseblock', 'gorgo_coral_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.sea_pen_count'
        db.add_column('scenarios_leaseblock', 'sea_pen_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.sea_pen_name'
        db.add_column('scenarios_leaseblock', 'sea_pen_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.hard_coral_count'
        db.add_column('scenarios_leaseblock', 'hard_coral_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.hard_coral_name'
        db.add_column('scenarios_leaseblock', 'hard_coral_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_depression'
        db.add_column('scenarios_leaseblock', 'seabed_depression',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_low_slope'
        db.add_column('scenarios_leaseblock', 'seabed_low_slope',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_steep'
        db.add_column('scenarios_leaseblock', 'seabed_steep',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_mid_flat'
        db.add_column('scenarios_leaseblock', 'seabed_mid_flat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_side_slow'
        db.add_column('scenarios_leaseblock', 'seabed_side_slow',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_high_flat'
        db.add_column('scenarios_leaseblock', 'seabed_high_flat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_high_slope'
        db.add_column('scenarios_leaseblock', 'seabed_high_slope',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.seabed_total'
        db.add_column('scenarios_leaseblock', 'seabed_total',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.discharge_min_distance'
        db.add_column('scenarios_leaseblock', 'discharge_min_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.discharge_max_distance'
        db.add_column('scenarios_leaseblock', 'discharge_max_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.discharge_mean_distance'
        db.add_column('scenarios_leaseblock', 'discharge_mean_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.discharge_flow_min_distance'
        db.add_column('scenarios_leaseblock', 'discharge_flow_min_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.discharge_flow_max_distance'
        db.add_column('scenarios_leaseblock', 'discharge_flow_max_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.discharge_flow_mean_distance'
        db.add_column('scenarios_leaseblock', 'discharge_flow_mean_distance',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.dredge_site'
        db.add_column('scenarios_leaseblock', 'dredge_site',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.wpa'
        db.add_column('scenarios_leaseblock', 'wpa',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LeaseBlock.variety_substrate'
        db.add_column('scenarios_leaseblock', 'variety_substrate',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LeaseBlock.majority_substrate'
        db.add_column('scenarios_leaseblock', 'majority_substrate',
                      self.gf('django.db.models.fields.CharField')(max_length=35, null=True, blank=True),
                      keep_default=False)

        # Adding field 'LeaseBlock.geometry_client'
        db.add_column('scenarios_leaseblock', 'geometry_client',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LeaseBlock.majority_seabed'
        db.delete_column('scenarios_leaseblock', 'majority_seabed')

        # Deleting field 'LeaseBlock.variety_seabed'
        db.delete_column('scenarios_leaseblock', 'variety_seabed')

        # Deleting field 'LeaseBlock.lace_coral_count'
        db.delete_column('scenarios_leaseblock', 'lace_coral_count')

        # Deleting field 'LeaseBlock.lace_coral_name'
        db.delete_column('scenarios_leaseblock', 'lace_coral_name')

        # Deleting field 'LeaseBlock.black_coral_count'
        db.delete_column('scenarios_leaseblock', 'black_coral_count')

        # Deleting field 'LeaseBlock.black_coral_name'
        db.delete_column('scenarios_leaseblock', 'black_coral_name')

        # Deleting field 'LeaseBlock.soft_coral_count'
        db.delete_column('scenarios_leaseblock', 'soft_coral_count')

        # Deleting field 'LeaseBlock.soft_coral_name'
        db.delete_column('scenarios_leaseblock', 'soft_coral_name')

        # Deleting field 'LeaseBlock.gorgo_coral_count'
        db.delete_column('scenarios_leaseblock', 'gorgo_coral_count')

        # Deleting field 'LeaseBlock.gorgo_coral_name'
        db.delete_column('scenarios_leaseblock', 'gorgo_coral_name')

        # Deleting field 'LeaseBlock.sea_pen_count'
        db.delete_column('scenarios_leaseblock', 'sea_pen_count')

        # Deleting field 'LeaseBlock.sea_pen_name'
        db.delete_column('scenarios_leaseblock', 'sea_pen_name')

        # Deleting field 'LeaseBlock.hard_coral_count'
        db.delete_column('scenarios_leaseblock', 'hard_coral_count')

        # Deleting field 'LeaseBlock.hard_coral_name'
        db.delete_column('scenarios_leaseblock', 'hard_coral_name')

        # Deleting field 'LeaseBlock.seabed_depression'
        db.delete_column('scenarios_leaseblock', 'seabed_depression')

        # Deleting field 'LeaseBlock.seabed_low_slope'
        db.delete_column('scenarios_leaseblock', 'seabed_low_slope')

        # Deleting field 'LeaseBlock.seabed_steep'
        db.delete_column('scenarios_leaseblock', 'seabed_steep')

        # Deleting field 'LeaseBlock.seabed_mid_flat'
        db.delete_column('scenarios_leaseblock', 'seabed_mid_flat')

        # Deleting field 'LeaseBlock.seabed_side_slow'
        db.delete_column('scenarios_leaseblock', 'seabed_side_slow')

        # Deleting field 'LeaseBlock.seabed_high_flat'
        db.delete_column('scenarios_leaseblock', 'seabed_high_flat')

        # Deleting field 'LeaseBlock.seabed_high_slope'
        db.delete_column('scenarios_leaseblock', 'seabed_high_slope')

        # Deleting field 'LeaseBlock.seabed_total'
        db.delete_column('scenarios_leaseblock', 'seabed_total')

        # Deleting field 'LeaseBlock.discharge_min_distance'
        db.delete_column('scenarios_leaseblock', 'discharge_min_distance')

        # Deleting field 'LeaseBlock.discharge_max_distance'
        db.delete_column('scenarios_leaseblock', 'discharge_max_distance')

        # Deleting field 'LeaseBlock.discharge_mean_distance'
        db.delete_column('scenarios_leaseblock', 'discharge_mean_distance')

        # Deleting field 'LeaseBlock.discharge_flow_min_distance'
        db.delete_column('scenarios_leaseblock', 'discharge_flow_min_distance')

        # Deleting field 'LeaseBlock.discharge_flow_max_distance'
        db.delete_column('scenarios_leaseblock', 'discharge_flow_max_distance')

        # Deleting field 'LeaseBlock.discharge_flow_mean_distance'
        db.delete_column('scenarios_leaseblock', 'discharge_flow_mean_distance')

        # Deleting field 'LeaseBlock.dredge_site'
        db.delete_column('scenarios_leaseblock', 'dredge_site')

        # Deleting field 'LeaseBlock.wpa'
        db.delete_column('scenarios_leaseblock', 'wpa')
