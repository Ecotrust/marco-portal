...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('scenarios_scenario', 'input_dist_port')


    def backwards(self, orm):
        
        # Adding field 'Scenario.input_dist_port'
        db.add_column('scenarios_scenario', 'input_dist_port', self.gf('django.db.models.fields.FloatField')(default=5), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 6, 11, 17, 35, 575000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 6, 11, 17, 35, 575000)'}),
