...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LookupInfo.dashstyle'
        db.add_column('data_manager_lookupinfo', 'dashstyle',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LookupInfo.dashstyle'
        db.delete_column('data_manager_lookupinfo', 'dashstyle')
