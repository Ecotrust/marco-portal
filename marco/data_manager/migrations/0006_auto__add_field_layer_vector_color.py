...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.vector_color'
        db.add_column('data_manager_layer', 'vector_color',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.vector_color'
        db.delete_column('data_manager_layer', 'vector_color')
