...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.vector_fill'
        db.add_column('data_manager_layer', 'vector_fill',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.vector_fill'
        db.delete_column('data_manager_layer', 'vector_fill')
