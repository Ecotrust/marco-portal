...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LookupInfo.dashtyle'
        db.add_column('data_manager_lookupinfo', 'dashtyle',
                      self.gf('django.db.models.fields.CharField')(default='solid', max_length=11),
                      keep_default=False)

        # Adding field 'LookupInfo.fill'
        db.add_column('data_manager_lookupinfo', 'fill',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LookupInfo.dashtyle'
        db.delete_column('data_manager_lookupinfo', 'dashtyle')

        # Deleting field 'LookupInfo.fill'
        db.delete_column('data_manager_lookupinfo', 'fill')
    ...
    models = {
        ...
        'data_manager.lookupinfo': {
            ...
            'dashtyle': ('django.db.models.fields.CharField', [], {'default': "'solid'", 'max_length': '11'}),
