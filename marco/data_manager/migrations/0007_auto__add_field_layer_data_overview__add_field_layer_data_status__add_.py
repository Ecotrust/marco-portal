...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.data_overview'
        db.add_column('data_manager_layer', 'data_overview',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.data_status'
        db.add_column('data_manager_layer', 'data_status',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.data_source'
        db.add_column('data_manager_layer', 'data_source',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.data_notes'
        db.add_column('data_manager_layer', 'data_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.data_overview'
        db.delete_column('data_manager_layer', 'data_overview')

        # Deleting field 'Layer.data_status'
        db.delete_column('data_manager_layer', 'data_status')

        # Deleting field 'Layer.data_source'
        db.delete_column('data_manager_layer', 'data_source')

        # Deleting field 'Layer.data_notes'
        db.delete_column('data_manager_layer', 'data_notes')
