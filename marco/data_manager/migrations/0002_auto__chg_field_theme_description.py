...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_manager_theme', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Theme.description'
        db.alter_column('data_manager_theme', 'description', self.gf('django.db.models.fields.CharField')(max_length=755, null=True))
    ...
    models = {
        'data_manager.layer': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '755', 'null': 'True', 'blank': 'True'}),
