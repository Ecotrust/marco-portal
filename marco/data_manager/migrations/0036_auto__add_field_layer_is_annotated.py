...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.is_annotated'
        db.add_column('data_manager_layer', 'is_annotated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.is_annotated'
        db.delete_column('data_manager_layer', 'is_annotated')
