...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AttributeInfo.precision'
        db.add_column('data_manager_attributeinfo', 'precision',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AttributeInfo.precision'
        db.delete_column('data_manager_attributeinfo', 'precision')
