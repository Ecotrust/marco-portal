...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('data_manager_dataneed_themes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dataneed', models.ForeignKey(orm['data_manager.dataneed'], null=False)),
            ('theme', models.ForeignKey(orm['data_manager.theme'], null=False))
        ))
        db.create_unique('data_manager_dataneed_themes', ['dataneed_id', 'theme_id'])


    def backwards(self, orm):
        # Removing M2M table for field themes on 'DataNeed'
        db.delete_table('data_manager_dataneed_themes')
