...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.legend_title'
        db.add_column('data_manager_layer', 'legend_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.legend_title'
        db.delete_column('data_manager_layer', 'legend_title')
