...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataNeed.archived'
        db.add_column('data_manager_dataneed', 'archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataNeed.archived'
        db.delete_column('data_manager_dataneed', 'archived')
