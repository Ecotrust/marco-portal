...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.header_image'
        db.add_column('data_manager_theme', 'header_image',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.header_image'
        db.delete_column('data_manager_theme', 'header_image')
