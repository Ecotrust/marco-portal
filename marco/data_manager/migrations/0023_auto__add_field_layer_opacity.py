...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.opacity'
        db.add_column('data_manager_layer', 'opacity',
                      self.gf('django.db.models.fields.FloatField')(default=0.5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.opacity'
        db.delete_column('data_manager_layer', 'opacity')
