...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Layer.shareable'
        db.delete_column('data_manager_layer', 'shareable')

        # Adding field 'Layer.shareable_url'
        db.add_column('data_manager_layer', 'shareable_url',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Layer.shareable'
        db.add_column('data_manager_layer', 'shareable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Layer.shareable_url'
        db.delete_column('data_manager_layer', 'shareable_url')
