...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.feature_image'
        db.add_column('data_manager_theme', 'feature_image',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Theme.feature_excerpt'
        db.add_column('data_manager_theme', 'feature_excerpt',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Theme.feature_link'
        db.add_column('data_manager_theme', 'feature_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.feature_image'
        db.delete_column('data_manager_theme', 'feature_image')

        # Deleting field 'Theme.feature_excerpt'
        db.delete_column('data_manager_theme', 'feature_excerpt')

        # Deleting field 'Theme.feature_link'
        db.delete_column('data_manager_theme', 'feature_link')
