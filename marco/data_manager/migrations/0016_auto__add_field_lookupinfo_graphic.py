...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LookupInfo.graphic'
        db.add_column('data_manager_lookupinfo', 'graphic',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LookupInfo.graphic'
        db.delete_column('data_manager_lookupinfo', 'graphic')
