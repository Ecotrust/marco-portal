...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Layer.lookup_field'
        db.add_column('data_manager_layer', 'lookup_field',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Layer.lookup_field'
        db.delete_column('data_manager_layer', 'lookup_field')
