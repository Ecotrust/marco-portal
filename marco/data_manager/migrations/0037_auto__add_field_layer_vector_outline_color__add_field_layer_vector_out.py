...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.vector_outline_color'
        db.add_column('data_manager_layer', 'vector_outline_color',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.vector_outline_opacity'
        db.add_column('data_manager_layer', 'vector_outline_opacity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.vector_outline_color'
        db.delete_column('data_manager_layer', 'vector_outline_color')

        # Deleting field 'Layer.vector_outline_opacity'
        db.delete_column('data_manager_layer', 'vector_outline_opacity')
