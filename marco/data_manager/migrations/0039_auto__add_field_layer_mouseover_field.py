...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.mouseover_field'
        db.add_column('data_manager_layer', 'mouseover_field',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.mouseover_field'
        db.delete_column('data_manager_layer', 'mouseover_field')
