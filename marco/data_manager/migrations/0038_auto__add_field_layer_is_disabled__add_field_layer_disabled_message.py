...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.is_disabled'
        db.add_column('data_manager_layer', 'is_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Layer.disabled_message'
        db.add_column('data_manager_layer', 'disabled_message',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.is_disabled'
        db.delete_column('data_manager_layer', 'is_disabled')

        # Deleting field 'Layer.disabled_message'
        db.delete_column('data_manager_layer', 'disabled_message')
    ...
    models = {
        ...
        'data_manager.layer': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'disabled_message': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_annotated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'vector_outline_color': ('django.db.models.fields.CharField', [], {'max_length': '7', 'null': 'True', 'blank': 'True'}),
            'vector_outline_opacity': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
