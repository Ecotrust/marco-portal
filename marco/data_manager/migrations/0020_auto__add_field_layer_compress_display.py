...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.compress_display'
        db.add_column('data_manager_layer', 'compress_display',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.compress_display'
        db.delete_column('data_manager_layer', 'compress_display')
