...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.display_name'
        db.add_column('data_manager_theme', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='Undefined', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.display_name'
        db.delete_column('data_manager_theme', 'display_name')
