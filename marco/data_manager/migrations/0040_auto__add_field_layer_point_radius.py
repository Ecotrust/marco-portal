...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.point_radius'
        db.add_column('data_manager_layer', 'point_radius',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.point_radius'
        db.delete_column('data_manager_layer', 'point_radius')
    ...
    models = {
        ...
        'data_manager.layer': {
            ...
            'mouseover_field': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'opacity': ('django.db.models.fields.FloatField', [], {'default': '0.5', 'null': 'True', 'blank': 'True'}),
            'point_radius': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
