...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapView.url_hash'
        db.add_column('learn_mapview', 'url_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=2050, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MapView.url_hash'
        db.delete_column('learn_mapview', 'url_hash')
