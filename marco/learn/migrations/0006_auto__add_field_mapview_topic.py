...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapView.topic'
        db.add_column('learn_mapview', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['learn.Topic'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'MapView.topic'
        db.delete_column('learn_mapview', 'topic_id')
    ...
    models = {
        ...
        'learn.mapview': {
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['learn.Topic']", 'null': 'True', 'blank': 'True'}),
            'url_hash': ('django.db.models.fields.CharField', [], {'max_length': '2050', 'null': 'True', 'blank': 'True'})
        },
        'learn.topic': {
